  ...
  fluidPage(
              ...
              fluidRow(
                ...
                column(6, align = 'right',
                  ...
                  actionButton(inputId='cdiaglink2', label="Tutorial", icon = icon("university"),
                    onclick ="window.open('https://rsquaredacademy.github.io/olsrr-book/collinearity-diagnostics.html', '_blank')"),
