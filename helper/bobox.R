bobox <- function(fig_height = NULL, fig_width = NULL, fig_title = NULL,
                  ...
                  x_data = NULL, data = NULL, box_w = 0.9, box_coef = 1.5,
  ...
  p <- figure(height = fig_height, width = fig_width, title = fig_title,
    ...
    ly_boxplot(x = x_data, data = data, width = box_w, coef = box_coef,
               fill_color = box_col, fill_alpha = box_alp, 
...
boxx <- bobox(x_data = 'mpg', data = mtcars)
boxx
